...
# Create a rounded version for the data table
...
# Consolidated column names for data table display
...
server <- function(input, output) {
  # Render the data table using `data_for_table`
  output$data_table <- renderDT({
    datatable(
      data_for_table,
      options = table_options,  # Use the consolidated table options
      rownames = FALSE,
      colnames = table_column_names  # Use the consolidated column names
    ) |>
