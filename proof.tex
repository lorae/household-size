...
\hypertarget{case-1-a-plain-english-explanation-of-what-this-type-of-move-is}{%
\subsection{Case 1: a plain-English explanation of what this type of
move
is}\label{case-1-a-plain-english-explanation-of-what-this-type-of-move-is}}

\textbf{Figure 1.3: \(m_{k+1} = m_k - 1\)}
...
In this particular case, the initial number of occupants of household
\(k\) is exactly one larger than the initial number of occupants in
household \(k+1\). With such a shift, we anticipate no change in the
average person-level household size, because the composition of the
households remains the same: in essence, it is just the numbering that
changes. The algebra bears this out:
...
and then put the rest of the population into one remaining large
household.
